...
def main():
    ...
    if choices == "DNA Analysis":
        st.subheader("What is Bioinformatics?")
        st.write("Bioinformatics is a niche growing field that blends computer science techniques\
                 with biological research to develop better exisiting medical solutions.\
                 An example includes but not limited to personalised medicine.\
                 More of the latest technical fields are also becoming part of bioinformatic\
                 research such as computer vision for cell counting and analysis (same technology used in my\
                 undergraduate research) as well as machine learning to track the spread of an epidemic.")
        ...
        if st.checkbox("Online File"):
            ...
            if ncbi_id != "":
                Entrez.email = "Jtunuguntla@gmail.com"
